...
cross-engine raster inspection remain open release checks.
...
- Full supported-browser critical workflows, keyboard traversal,
  ...
  remain open in the [M5 release checklist](m5-release-checklist.md).
...
These limitations prevent an MVP completion claim even though the documented
workflows above are implemented and covered at their stated boundaries.
