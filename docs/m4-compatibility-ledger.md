...
| Essentials and hybrid data paths   | Implemented with recorded risk            | Full-profile Knight reaches level 30 with zero diagnostics; distinct two-component Hybrid selection reaches level 10 with one preserved unverified prerequisite. Alternate class/build records, automatic grants, explicit base-class aliases, talent choices, and sibling duplicate suppression use the generic evaluator. Epic Hybrid and broader build-family differential coverage remain M5 blockers. |
