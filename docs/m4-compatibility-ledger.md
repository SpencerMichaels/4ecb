...
| Dynamic class categories           | Implemented                               | Class, hybrid, `CountsAsClass`, multiclass, `PowersAsClass`, paragon multiclassing, universal skills, Diverse Study, Seeker, Versatile Master, and custom feat/power bypasses have direct fixtures.                                                                                                                                         |
...
| Essentials and hybrid data paths   | Implemented with recorded risk            | Alternate class/build records, automatic grants, hybrid categories, talent choices, and duplicate suppression use the generic evaluator. Native ordering/suppression that cannot be distinguished from serialized data remains an M5 differential-testing blocker.                                                                          |
...
| Natural-language prerequisites     | Implemented with safe fallback            | Ability, level/tier, training, power source, class/hybrid class, identity, negation, proficiency, deity/domain, multiclass markers, and alternatives are evaluated. The long tail is preserved and reported as `prerequisite.unverified`; expanding it is an M5 legality blocker.                                                           |
...
| Hand-specific and named power math | Blocking for MVP                          | The remaining native `SpecialCase` tail, explicit main/off-hand pairing, dual-implement hand selection, and some situational striker/conditional components need same-profile differential fixtures in M5. Preserved power text remains visible; the engine never fabricates certainty.                                                     |
